      ...
      <div className="w-full max-w-6xl items-center gap-12 lg:flex lg:justify-between">
        <div className="hidden max-w-xl flex-1 pb-10 pt-10 text-white lg:block">
          ...
          <h1 className="mt-8 text-5xl font-semibold leading-[1.02] tracking-[-0.04em] text-white">
            Control the full laundry operation,
            <span className="block text-white/85">from pickup to payout.</span>
          </h1>
          <p className="mt-6 max-w-lg text-base leading-7 text-slate-200">
            Monitor partner performance, keep revenue on track, and make sure every order, payment, and service decision stays visible.
          </p>
          <div className="mt-8 flex flex-wrap gap-3 text-sm text-slate-100/90">
            <span className="rounded-full border border-white/15 bg-white/5 px-3 py-1.5">Order oversight</span>
            <span className="rounded-full border border-white/15 bg-white/5 px-3 py-1.5">Revenue tracking</span>
            <span className="rounded-full border border-white/15 bg-white/5 px-3 py-1.5">Partner operations</span>
          </div>
        </div>
